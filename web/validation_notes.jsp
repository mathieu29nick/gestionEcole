...
<body>
    <h1 style="margin-top: 80px;text-align: center;">VALIDATION DES NOTES</h1>
    <div class="container" style="height: 400px;margin-top: 125px;background: #bfe1e7;">
            ...
            <table class="table">
                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: center;">Cell 1</td>
                        <td style="text-align: center;">Cell 1</td>
                        <td style="text-align: center;"><a href="ServletValiderNote">Valider</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
